function filter(type) {
    ...
    if (type === "all") {
        ...
        document.getElementById("btn-all").classList.remove("btn-md");
    };
    if (count == 0)
        document.getElementById("zeroPokemon").classList.remove("d-done");
    else
        document.getElementById("zeroPokemon").classList.add("d-done")
}
